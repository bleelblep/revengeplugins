    ...
    return <ScrollView style={{ flex: 1 }}>
        <View style={{ paddingHorizontal: 16, paddingTop: 12, paddingBottom: 4 }}>
            <Text style={{ color: "#B5BAC1", fontSize: 12, lineHeight: 16 }}>
                Hiding is local to this device and never leaves Discord. Experimental build:
                this version replaces the whole server bar component instead of blanking
                individual rows, aiming to avoid the empty-space/scroll-jump bug from the
                original Hide Servers plugin. Not yet verified against a live client -- if
                servers don't disappear, turn off "Hide servers in the bar" below and use the
                original Hide Servers plugin instead.
            </Text>
        </View>
